...
namespace Calemas.Erp.Application.Config
{
    public class DominioToDtoProfileCore : AutoMapper.Profile
    {
        ...
        public DominioToDtoProfileCore()
        {
            ...
            CreateMap(typeof(EstoqueMovimentacaoColaborador), typeof(EstoqueMovimentacaoColaboradorDtoSpecialized));
            ...
            CreateMap(typeof(SolicitacaoEstoque), typeof(SolicitacaoEstoqueDtoSpecializedReport));
            CreateMap(typeof(SolicitacaoEstoque), typeof(SolicitacaoEstoqueDtoSpecializedDetails));
