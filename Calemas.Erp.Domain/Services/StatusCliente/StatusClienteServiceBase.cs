    ...
    public class StatusClienteServiceBase : ServiceBase<StatusCliente>
    {
        ...
        protected virtual StatusCliente SaveDefault(StatusCliente statuscliente, StatusCliente statusclienteOld)
        {
            ...
            if (isNew)
				...
				statuscliente = this.UpdateDefault(statuscliente, statusclienteOld);
		...
		protected virtual StatusCliente UpdateDefault(StatusCliente statuscliente, StatusCliente statusclienteOld)
        {
