    ...
    public class TipoOrdemServicoServiceBase : ServiceBase<TipoOrdemServico>
    {
        ...
        protected virtual TipoOrdemServico SaveDefault(TipoOrdemServico tipoordemservico, TipoOrdemServico tipoordemservicoOld)
        {
            ...
            if (isNew)
				...
				tipoordemservico = this.UpdateDefault(tipoordemservico, tipoordemservicoOld);
		...
		protected virtual TipoOrdemServico UpdateDefault(TipoOrdemServico tipoordemservico, TipoOrdemServico tipoordemservicoOld)
        {
