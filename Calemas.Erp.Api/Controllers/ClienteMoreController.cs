...
{
	[Authorize]
    [Route("api/cliente/more")]
    public class ClienteMoreController : Controller
    {
        ...
        public ClienteMoreController(IClienteRepository rep, IClienteApplicationService app, ILoggerFactory logger)
        {
            this._rep = rep;
            this._app = app;
			this._logger = logger.CreateLogger<ClienteMoreController>();
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<ClienteDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - Cliente", dtos);
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<ClienteDtoSpecialized> dtos)
        {
            var result = new HttpResult<ClienteDto>(this._logger);
            try
            {
