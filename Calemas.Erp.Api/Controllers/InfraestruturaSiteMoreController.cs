...
{
	[Authorize]
    [Route("api/infraestruturasite/more")]
    public class InfraestruturaSiteMoreController : Controller
    {

        private readonly IInfraestruturaSiteRepository _rep;
        ...
        public async Task<IActionResult> Get([FromQuery]InfraestruturaSiteFilter filters)
        {
            ...
            try
            {
				...
				if (filters.FilterBehavior == FilterBehavior.Export)
                {
                    ...
                    var file = export.ExportFile(this.Response, searchResult, "InfraestruturaSite");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<InfraestruturaSiteDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - InfraestruturaSite", dtos);
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<InfraestruturaSiteDtoSpecialized> dtos)
        {
            var result = new HttpResult<InfraestruturaSiteDto>(this._logger);
            try
            {
