...
{
	[Authorize]
    [Route("api/statuspagamento/more")]
    public class StatusPagamentoMoreController : Controller
    {

        private readonly IStatusPagamentoRepository _rep;
        ...
        public async Task<IActionResult> Get([FromQuery]StatusPagamentoFilter filters)
        {
            ...
            try
            {
				...
				if (filters.FilterBehavior == FilterBehavior.Export)
                {
                    ...
                    var file = export.ExportFile(this.Response, searchResult, "StatusPagamento");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<StatusPagamentoDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - StatusPagamento", dtos);
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<StatusPagamentoDtoSpecialized> dtos)
        {
            var result = new HttpResult<StatusPagamentoDto>(this._logger);
            try
            {
