...
{
	[Authorize]
    [Route("api/estoque/more")]
    public class EstoqueMoreController : Controller
    {

        private readonly IEstoqueRepository _rep;
        ...
        public async Task<IActionResult> Get([FromQuery]EstoqueFilter filters)
        {
            ...
            try
            {
				...
				if (filters.FilterBehavior == FilterBehavior.Export)
                {
                    ...
                    var file = export.ExportFile(this.Response, searchResult, "Estoque");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<EstoqueDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - Estoque", dtos);
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<EstoqueDtoSpecialized> dtos)
        {
            var result = new HttpResult<EstoqueDto>(this._logger);
            try
            {
