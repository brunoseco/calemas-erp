...
namespace Calemas.Erp.Api.Controllers
{
    ...
    public class SolicitacaoEstoqueController : Controller
    {
        ...
        public SolicitacaoEstoqueController(ISolicitacaoEstoqueApplicationService app, ILoggerFactory logger, IHostingEnvironment env)
        {
            this._app = app;
		...
		public async Task<IActionResult> Get(int id, [FromQuery]SolicitacaoEstoqueFilter filters)
		{
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - SolicitacaoEstoque", id);
            }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]SolicitacaoEstoqueDtoSpecialized dto)
        {
            var result = new HttpResult<SolicitacaoEstoqueDto>(this._logger);
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]SolicitacaoEstoqueDtoSpecialized dto)
        {
            var result = new HttpResult<SolicitacaoEstoqueDto>(this._logger);
            try
            {
