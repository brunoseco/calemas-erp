...
{
	[Authorize]
    [Route("api/setor/more")]
    public class SetorMoreController : Controller
    {
        ...
        public async Task<IActionResult> Get([FromQuery]SetorFilter filters)
        {
            ...
            try
            {
				...
				if (filters.FilterBehavior == FilterBehavior.Export)
                {
                    ...
                    var file = export.ExportFile(this.Response, searchResult, "Setor");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<SetorDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - Setor", dtos);
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<SetorDtoSpecialized> dtos)
        {
            var result = new HttpResult<SetorDto>(this._logger);
            try
            {
