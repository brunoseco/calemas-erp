...
{
	[Authorize]
    [Route("api/agenda/more")]
    public class AgendaMoreController : Controller
    {

        private readonly IAgendaRepository _rep;
        ...
        public async Task<IActionResult> Get([FromQuery]AgendaFilter filters)
        {
            ...
            try
            {
				...
				if (filters.FilterBehavior == FilterBehavior.Export)
                {
                    ...
                    var file = export.ExportFile(this.Response, searchResult, "Agenda");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<AgendaDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - Agenda", dtos);
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<AgendaDtoSpecialized> dtos)
        {
            var result = new HttpResult<AgendaDto>(this._logger);
            try
            {
