            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12" v-bind:class="{ 'has-danger': formErrors.has('form-edit.nivelAcessoId') }">
                        ...
                        <select v-select="{ dataitem: 'PlanoConta', default: 'Selecione' }" v-model="crud.edit.model.nivelAcessoId" class="form-control" name="planoContaId" v-validate="'required'"></select>
                    </div>
					...
					<div class="form-group col-md-12" v-bind:class="{ 'has-danger': formErrors.has('form-create.pessoaId') }">
                        ...
                        <input type="text" class="form-control" name="pessoaId" placeholder="PessoaId" v-model="crud.edit.model.pessoaId" v-validate="'required'" />
                    </div>
