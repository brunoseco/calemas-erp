...
<script>
    ...
    export default {
        ...
        components: { formPartial },
        mixins: [crudBase],
        data() {
            return {
                model: { solicitacaoEstoqueId: this.$route.params.id },
                filterOnEnter: false,
                resource: "solicitacaoestoquemovimentacao",
            }
        },
        methods: {
            onBeforeCreate: function (model) {
                this.model.solicitacaoEstoqueId = this.$route.params.id;
            },
        },
        mounted() {
            let id = this.$route.params.id;
            this.filter.solicitacaoEstoqueId = id;
            this.executeFilter();
        }
    }
</script>
