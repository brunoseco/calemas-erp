<template>
    <div class="wrapper">
        ...
        <div class="row" style="margin-bottom: 1rem;margin-top: -0.5rem;">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
                <h6 class="page-title txt-color-blueDark">
                    ...
                    Estoque
                    <span>Estoque do colaborador</span>
                </h6>
            </div>
        ...
        <modal title="Cadastro de Movimentação de estoque do colaborador" v-model="modalCreateIsOpen" effect="fade/zoom" type="modal-success" :large="true">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">Cadastro de Movimentação de estoque do colaborador</h4>
        ...
        <modal title="Edição de Movimentação de estoque do colaborador" v-model="modalEditIsOpen" effect="fade/zoom" type="modal-primary" :large="true">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">Edição de Movimentação de estoque do colaborador</h4>
        ...
        <modal title="Exclusão de Movimentação de estoque do colaborador" v-model="modalDeleteIsOpen" type="modal-danger" effect="fade/zoom">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">Exclusão de Movimentação de estoque do colaborador</h4>
