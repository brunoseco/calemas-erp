<template>
    <modal title="Edição de Tipo de ordem de serviço" v-model="crud.edit.modalIsOpen" effect="fade/zoom" :primary="true" :large="true">
        ...
        <form data-vv-scope="form-edit" v-on:submit.prevent="crud.edit.executeAction()">
            <fieldset>
                <legend>Dados</legend>
                <div class="row">
                    <input type="hidden" class="form-control" name="tipoOrdemServicoId" v-model="crud.edit.model.tipoOrdemServicoId" />
