<template>
    <modal title="Edição de Unidade de medida" v-model="crud.edit.modalIsOpen" effect="fade/zoom" :primary="true" :large="true">
        ...
        <form data-vv-scope="form-edit" v-on:submit.prevent="crud.edit.executeAction()">
            <fieldset>
                <legend>Dados</legend>
                <div class="row">
                    <input type="hidden" class="form-control" name="unidadeMedidaId" v-model="crud.edit.model.unidadeMedidaId" />
