<template>
    <div class="wrapper">
                            ...
                            <tbody>
                                <tr v-for="item in result.itens" class="animated fadeIn">
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-primary" @click="openEdit(item.unidadeMedidaId, item)">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" @click="openDelete(item.unidadeMedidaId, item)">
        ...
        <modal title="Exclusão de Estoque" v-model="modalDeleteIsOpen" type="modal-danger" effect="fade/zoom">
            ...
            <form type="post" v-on:submit.prevent="executeDelete(model)" id="form-delete">
                <div class="row">
