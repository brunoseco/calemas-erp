<template>
    <div class="wrapper">
        ...
        <modal title="Cadastro de Condomínio" v-model="modalCreateIsOpen" effect="fade/zoom" type="modal-success" :large="true">
        ...
        <modal title="Edição de Condomínio" v-model="modalEditIsOpen" effect="fade/zoom" type="modal-primary" :large="true">
            <div slot="modal-header" class="modal-header">
