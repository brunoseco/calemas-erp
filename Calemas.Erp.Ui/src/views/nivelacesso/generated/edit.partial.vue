<template>
    <modal title="Edição de Nível de acesso" v-model="crud.edit.modalIsOpen" effect="fade/zoom" :primary="true" :large="true">
        ...
        <form data-vv-scope="form-edit" v-on:submit.prevent="crud.edit.executeAction()">
            <fieldset>
                <legend>Dados</legend>
                <div class="row">
                    <input type="hidden" class="form-control" name="nivelAcessoId" v-model="crud.edit.model.nivelAcessoId" />
