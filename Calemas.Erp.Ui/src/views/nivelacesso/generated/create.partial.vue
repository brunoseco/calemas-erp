<template>
    <modal title="Cadastro de Nível de acesso" v-model="crud.create.modalIsOpen" effect="fade/zoom" :success="true" :large="true">
        ...
        <form data-vv-scope="form-create" v-on:submit.prevent="crud.create.executeAction()">
            <fieldset>
                <legend>Dados</legend>
                <div class="row">
                    <input type="hidden" class="form-control" name="nivelAcessoId" v-model="crud.create.model.nivelAcessoId" />
