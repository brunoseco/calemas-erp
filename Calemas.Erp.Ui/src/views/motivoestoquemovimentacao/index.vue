<template>
    <div class="wrapper">
                            ...
                            <tbody>
                                <tr v-for="item in result.itens" class="animated fadeIn">
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-primary" v-tooltip.left="'Editar'" @click="openEdit(item.motivoEstoqueMovimentacaoId, item)">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" v-tooltip.left="'Remover'" @click="openDelete(item.motivoEstoqueMovimentacaoId, item)">
        ...
        <modal title="Cadastro de Motivo de movimentação de estoque" v-model="modalCreateIsOpen" effect="fade/zoom" type="modal-success" :large="true">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">Cadastro de Motivo de movimentação de estoque</h4>
        ...
        <modal title="Edição de Motivo de movimentação de estoque" v-model="modalEditIsOpen" effect="fade/zoom" type="modal-primary" :large="true">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">Edição de Motivo de movimentação de estoque</h4>
        ...
        <modal title="Exclusão de Motivo de movimentação de estoque" v-model="modalDeleteIsOpen" type="modal-danger" effect="fade/zoom">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">Exclusão de Motivo de movimentação de estoque</h4>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                resource: "motivoestoquemovimentacao",
            }
        }
    }
</script>