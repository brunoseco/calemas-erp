...
{
	[Authorize]
    [Route("api/pessoa/more")]
    public class PessoaMoreController : Controller
    {
        ...
        public PessoaMoreController(IPessoaRepository rep, IPessoaApplicationService app, ILoggerFactory logger)
        {
            this._rep = rep;
            this._app = app;
			this._logger = logger.CreateLogger<PessoaMoreController>();
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<PessoaDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Calemas.Erp - Pessoa", dtos);
            }

        }

	[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<PessoaDtoSpecialized> dtos)
        {
            var result = new HttpResult<PessoaDto>(this._logger);
            try
            {
