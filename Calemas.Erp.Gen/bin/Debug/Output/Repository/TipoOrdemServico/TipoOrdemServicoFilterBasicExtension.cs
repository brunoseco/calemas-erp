...
{
    public static class TipoOrdemServicoFilterBasicExtension
    {

        public static IQueryable<TipoOrdemServico> WithBasicFilters(this IQueryable<TipoOrdemServico> queryBase, TipoOrdemServicoFilter filters)
        {
