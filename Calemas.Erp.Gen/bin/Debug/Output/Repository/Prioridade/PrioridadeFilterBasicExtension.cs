...
{
    public static class PrioridadeFilterBasicExtension
    {

        public static IQueryable<Prioridade> WithBasicFilters(this IQueryable<Prioridade> queryBase, PrioridadeFilter filters)
        {
			...
			{ 
				...
				queryFilter = queryFilter.Where(_=>_.Cor.Contains(filters.Cor));
			};
