...
{
    public static class StatusOrdemServicoFilterBasicExtension
    {

        public static IQueryable<StatusOrdemServico> WithBasicFilters(this IQueryable<StatusOrdemServico> queryBase, StatusOrdemServicoFilter filters)
        {
